...
This plugin is intended to allow a user to create an in-memory snapshot of an SCL file in OpenSCD.
It only creates a copy of the same file, appending it with the current date and time.
